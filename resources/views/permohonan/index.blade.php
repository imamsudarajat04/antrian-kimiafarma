...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('permohonan.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus"></i> Tambah Data</a>
        </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered dt-responsive nowrap w-100 display" id="tablePermohonan">
                                <thead>
                                    <tr>
                                        <th width="70px">No</th>
                                        <th>Nama Pasien</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Anda yakin ingin menghapus data permohonan ini ?</p>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-danger delete-permohonan" value="">
                            <strong>
                                Hapus
                            </strong>
                        </button>
...
@push('customjs')
    ...
    <script>
        $(document).ready( function () {
            $('#tablePermohonan').DataTable({
                ...
                "fnCreatedRow": function(nRow, data) {
                    $(nRow).attr('id', 'permohonan' + data.id);
                },
            });
        } );
        ...
        var id = $(this).data('id');
        $(".modal-footer .delete-permohonan").val(id);

        jQuery(document).ready(function($) {
            ////----- DELETE a link and remove from the page -----////
            jQuery('.delete-permohonan').click(function() {
                var permohonan_id = $(this).val();
                $.ajaxSetup({
                    headers: {
                ...
                $.ajax({
                    type: "DELETE",
                    url: 'delete-permohonan/' + permohonan_id,
                    success: function(data) {
                        ...
                        var oTable = $('#tablePermohonan').dataTable();
